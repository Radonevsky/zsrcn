...
const articles = ref([
    ...
    },
    {
        ...
        subTitle: null,
        content: 'Указ Президента РФ от 1 июня 2012 г. N 761\n' +
...
<template>
    <ContentContainer>
        <div v-if="currentArticle" class="text-[20px] font-roboto400 text-link-dark-blue">
            ...
            ></h4>
            <div v-if="currentArticle.name === 'center-inspection-reports'">
                <document-download-upload name="Акт проверки" type="inspection-report"></document-download-upload>
            </div>
